...
import contentKnowledgeRoutes from './routes/contentKnowledge.js';
import contentTrendsRoutes from './routes/contentTrends.js';
import trendProvidersRoutes from './routes/trendProviders.js';
...
app.use('/api/content-knowledge', contentKnowledgeRoutes);
app.use('/api/content-trends', contentTrendsRoutes);
app.use('/api/trend-providers', trendProvidersRoutes);
